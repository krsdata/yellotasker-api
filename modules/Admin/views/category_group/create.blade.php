                            ...
                            <div class="portlet light portlet-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Create Category Group</span>
                                    </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            ...
                                            @if(!Input::has('error'))
                                              ...
                                              {!! Form::model($category_group, ['route' => ['category-group.store'],'class'=>'form-horizontal','id'=>'cat_group_form','files' => true]) !!}
                                                  @include('packages::category_group.form')
                                              {!! Form::close() !!}
