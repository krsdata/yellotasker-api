             ...
             <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Edit Group</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet light portlet-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Edit Category Group</span>
                                    </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            ...
                                            @if(!Input::has('error'))
                                              ...
                                              {!! Form::model($category_group, ['method' => 'PATCH', 'route' => ['category-group.update', $category_group->id],'class'=>'form-horizontal','files' => true]) !!}
                                                  @include('packages::category_group.form', compact('category_group'))
                                              {!! Form::close() !!}
